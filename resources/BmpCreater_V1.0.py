...
class FontManager():
    def __init__(self):
        self.font_info = {"./font.info"}
        self.icon_info = {"./icon.info"}
        self.font_dict = dict()
...
class BmpCreater():
    ...
    def __init__(self,color_type="RGB",color=(255,255,255),ch_font="",asc_font="",only_sysfont = False,relative_path = "./resources/"):
...
if __name__ == "__main__":
    ch_font="HZK16宋体"
    asc_font="ASC2010"
    FontCreater = BmpCreater(color_type="RGB",color=(255,200,0),ch_font=ch_font,asc_font=asc_font,only_sysfont = False,relative_path = "./")
    font_img = FontCreater.create_character(vertical=False, text="`wheelchair32x32`欢迎乘坐200路外环公交车！", ch_font_size=24, ch_bold_size_x=2, ch_bold_size_y=1, space=0, scale=80, auto_scale=0, scale_sys_font_only=1, new_width = 80, new_height = 32, y_offset = 0, style = 0)
